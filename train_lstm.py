...
def train(args: DictConfig) -> None:
    ...
    if args.use_wandb:
        wandb.init(project="Project 1", name=f"{args.LSTM.Network.name}", config=OmegaConf.to_container(args, resolve=True))
    print("[INFO] Agent name: ", args.LSTM.Network.name)
